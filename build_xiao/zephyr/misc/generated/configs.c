...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_STACK_SIZE, 840);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_CAF_AGGREGATOR_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_SENSOR_STUB_ENABLED, 1);
