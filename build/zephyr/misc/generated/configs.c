...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_ROLE_HID_PERIPHERAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_PERIPHERAL_TYPE_MOUSE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_USE_DEFAULT_REPORT_DESCR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HID_REPORT_DESC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HID_REPORT_MOUSE_SUPPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HID_BOOT_INTERFACE_MOUSE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_DEVICE_PRODUCT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_DEVICE_MANUFACTURER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_DEVICE_VID, 0x1915);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_DEVICE_PID, 0x52DE);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_DEVICE_GENERATION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BT_PERIPHERAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ID_UNPAIR_MATCHING_BONDS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ID_ALLOW_UNAUTH_OVERWRITE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_CHRC_POOL_SIZE, 7);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DIS_PNP_PID, 0x52DE);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_LOG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_RTT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_RTT_BUFFER_SIZE_UP, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INIT_LOG_BATTERY_STATE_EVENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INIT_LOG_BATTERY_LEVEL_EVENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INIT_LOG_BLE_DISC_COMPLETE_EVENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INIT_LOG_BLE_QOS_EVENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INIT_LOG_BLE_DONGLE_PEER_EVENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INIT_LOG_SELECTOR_EVENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INIT_LOG_PASSKEY_EVENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INIT_LOG_CONFIG_EVENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INIT_LOG_HID_SUBSCRIBER_EVENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INIT_LOG_HID_SUBSCRIPTION_EVENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INIT_LOG_WHEEL_EVENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INIT_LOG_HID_NOTIFICATION_EVENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BOARD_PM_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BOARD_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BOARD_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_STATE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_ADV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_FAST_ADV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_FILTER_ACCEPT_LIST, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV_FLAGS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV_GAP_APPEARANCE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV_DEVICE_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV_SWIFT_PAIR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV_TX_POWER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_ADV_PROV_UUID16_ALL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_POWER_MANAGER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_SETTINGS_LOADER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NVS_LOG_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HID_STATE_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HID_STATE_HID_KEYMAP_DEF_PATH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HID_STATE_HID_KEYBOARD_LEDS_DEF_PATH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HID_STATE_PM_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HID_REPORT_EXPIRATION, 500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HID_EVENT_QUEUE_SIZE, 12);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HID_STATE_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HID_STATE_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_LED_STATE_DEF_PATH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_LED_STATE_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_LED_STATE_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_BOND_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_USE_DEFAULT_ID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_PEER_CONTROL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_PEER_CONTROL_BUTTON, 0x0000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_PEER_SELECT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_PEER_ERASE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_PEER_ERASE_ON_START, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_DONGLE_PEER_SELECTOR_ID, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_DONGLE_PEER_SELECTOR_POS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_BOND_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_BOND_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_LATENCY_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_SECURITY_FAIL_TIMEOUT_S, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_LOW_LATENCY_LOCK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_LATENCY_PM_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_LATENCY_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BLE_LATENCY_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_DEV_DESCR_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_DFU_MCUMGR_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_DFU_MCUMGR_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_DFU_MCUMGR_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AULI_ENABLE_FS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_WIPE_STORAGE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HIDS_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HIDS_FIRST_REPORT_DELAY, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HIDS_ATTR_MAX, 19);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HIDS_INPUT_REP_MAX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HIDS_OUTPUT_REP_MAX, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HIDS_FEATURE_REP_MAX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HIDS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HIDS_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BAS_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BAS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_BAS_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_CONFIG_CHANNEL_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_CONFIG_CHANNEL_TIMEOUT, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_CONFIG_CHANNEL_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_CONFIG_CHANNEL_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INFO_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_INFO_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_CONFIG_CHANNEL_DFU_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_CONFIG_CHANNEL_DFU_SYNC_BUFFER_SIZE, 128);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_CONFIG_CHANNEL_DFU_VID, 0x1915);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_CONFIG_CHANNEL_DFU_PID, 0x52DE);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_CONFIG_CHANNEL_DFU_GENERATION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_CONFIG_CHANNEL_DFU_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_CONFIG_CHANNEL_DFU_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HFCLK_LOCK_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_HWID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_DFU_LOCK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_DFU_LOCK_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_DFU_LOCK_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_COMMON, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESKTOP_COMMON_MODULES, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_STACK_SIZE, 2376);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_MTU, 260);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_SIZE, 27);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_SIZE, 264);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV_SWIFT_PAIR_COOL_DOWN_DURATION, 30);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV_TX_POWER_CORRECTION_VAL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_GRACE_PERIOD, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_USE_LLPM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_IMG_VERSION_CMP_USE_BUILD_NUMBER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_IMG_MUTEX, 1);
